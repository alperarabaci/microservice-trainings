...
kafka-topics --zookeeper $1:2181 --topic customer --delete --if-not-exists
kafka-topics --zookeeper $1:2181 --topic payment-request --delete --if-not-exists
kafka-topics --zookeeper $1:2181 --topic payment-response --delete --if-not-exists
kafka-topics --zookeeper $1:2181 --topic restaurant-approval-request --delete --if-not-exists
kafka-topics --zookeeper $1:2181 --topic restaurant-approval-response --delete --if-not-exists
