package com.training.food.ordering.kafka.consumer.config;

import com.training.food.ordering.kafka.config.data.KafkaConfigData;
import com.training.food.ordering.kafka.config.data.KafkaConsumerConfigData;
