...
public class PaymentResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private com.training.food.ordering.kafka.order.avro.model.PaymentStatus paymentStatus;
   ...
   */
  public PaymentResponseAvroModel(java.lang.String id, java.lang.String sagaId, java.lang.String paymentId, java.lang.String customerId, java.lang.String orderId, java.math.BigDecimal price, java.time.Instant createdAt, com.training.food.ordering.kafka.order.avro.model.PaymentStatus paymentStatus, java.util.List<java.lang.String> failureMessages) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 7: paymentStatus = (com.training.food.ordering.kafka.order.avro.model.PaymentStatus)value$; break;
   ...
   */
  public com.training.food.ordering.kafka.order.avro.model.PaymentStatus getPaymentStatus() {
   ...
   * @param value the value to set.
   */
  public void setPaymentStatus(com.training.food.ordering.kafka.order.avro.model.PaymentStatus value) {
   ...
   */
  public static com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder newBuilder() {
    return new com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder();
  }
   ...
   * @return A new PaymentResponseAvroModel RecordBuilder
   */
  public static com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder newBuilder(com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder other) {
    if (other == null) {
      return new com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder();
    } else {
      return new com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder(other);
    }
  }
   ...
   * @return A new PaymentResponseAvroModel RecordBuilder
   */
  public static com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder newBuilder(com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel other) {
    if (other == null) {
      return new com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder();
    } else {
      return new com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentResponseAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder setSagaId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder setPaymentId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearPaymentId() {
      paymentId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder setCustomerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearCustomerId() {
      customerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder setOrderId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder setPrice(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder setPaymentStatus(com.training.food.ordering.kafka.order.avro.model.PaymentStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearPaymentStatus() {
      paymentStatus = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder setFailureMessages(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.food.ordering.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearFailureMessages() {
    ...
    public PaymentResponseAvroModel build() {
      try {
        ...
        record.paymentStatus = fieldSetFlags()[7] ? this.paymentStatus : (com.training.food.ordering.kafka.order.avro.model.PaymentStatus) defaultValue(fields()[7]);
